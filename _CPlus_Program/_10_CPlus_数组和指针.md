...
- [C Plus 数组和指针](#c-plus-数组和指针)
	...
	- [- int sum4d(int ar, int rows);](#--int-sum4dint-ar2030-int-rows)
...
5. 7. 指针减去一个整数：可以使用-运算符从一个指针中减去一个整数
